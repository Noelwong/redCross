...
class QC9ViewController: UIViewController {
    ...
    @IBOutlet weak var QC9Q5: UISegmentedControl!
    ...
    @IBAction func NextPage(_ sender: UIButton) {
        if (QC9Q1.selectedSegmentIndex == 1)&&(QC9Q2.selectedSegmentIndex == 1)&&(QC9Q3.selectedSegmentIndex == 1)&&(QC9Q4.selectedSegmentIndex == 1)&&(QC9Q5.selectedSegmentIndex == 1){
            performSegue(withIdentifier: "toQC10", sender: self)
        }else{
            // create the alert
